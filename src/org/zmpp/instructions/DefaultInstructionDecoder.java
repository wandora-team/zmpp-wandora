/*
 * $Id: DefaultInstructionDecoder.java 536 2008-02-19 06:03:27Z weiju $
 * 
...
public class DefaultInstructionDecoder implements InstructionDecoder {
  ...
  // ***********************************************************************
    ...
    // ******************************************
    /**
     * Create the basic information about the current instruction to be decoded.
     * The returned object contains the instruction form, the operand count type
     * and possibly, the opcode, if it is not an extended opcode.
     *
    ...
    /**
     * Extracts the operands from the instruction data. At this step of decoding
     * the some basic information about the instruction is available and could
     * be used for extraction of parameters.
     *
     ...
     * type number. If the type is unknown or OMITTED, no operand will be added
     * and the returned address will be equal to currentAddress.
     *
        ...
        if (info.isBranch()) {
            ...
            if ((offsetByte1 & 0x40) > 0) {
                ...
                if ((offsetByte1 & 0x20) == 0x20) { // Bit 14 set = negative
                    ...
                    offset = (short) ((0xC000 | ((offsetByte1 << 8) | (offsetByte2 & 0xff))));

                } else {

                    offset = (short) (((offsetByte1 & 0x3f) << 8) | (offsetByte2 & 0xff));
                }
